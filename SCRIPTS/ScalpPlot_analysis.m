...
saveas(gcf,append('D:\Documents_D\Imperial_D\EEG_data\AnalysisImages_and_results\Scalpplots\Scalpplots',n,'\Scalpplottest',num2str(i),'S',n,'P',num2str(position(i)),'t',num2str(times(1,i)),'_',num2str(times(2,i)),'.png'));
saveas(gcf,append('D:\Documents_D\Imperial_D\EEG_data\AnalysisImages_and_results\Scalpplots\Scalpplots',n,'\Scalpplottest',num2str(i),'S',n,'P',num2str(position(i)),'t',num2str(times(1,i)),'_',num2str(times(2,i)),'.eps'),'epsc');


title(append('S ',n,' P ',num2str(position(i))))
eeglab redraw;
end
